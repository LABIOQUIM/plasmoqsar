...
export default async function Home() {
  ...
  return (
    <PageLayout>
      ...
      <Box>
        <Equation value="-743.635 + 55.846*A + 460.630*B + 1576.396*C - 1.988*A^2 - 22.908*A*B - 53.923*A*C- 39.867*B^2 - 1167.069*B*C - 1428.253*C^2 + 0.026*A^3 + 0.865*A^2*B + 1.231*A^2*C - 3.654*A*B^2 + 15.510*A*B*C + 19.711*A*C^2 + 10.991*B^3 + 251.547*B^2*C^3 + 985.497*B*C^2 + 530.744*C^3 + 0.000*A^4 - 0.014*A^3 *B -0.017*A^3*C + 0.095*A^2*B^2 - 0.035*A^2*B*C + 0.018*A^2*C^2 - 0.317*A*B^3 - 0.805*A*B^2*C - 7.912*A*B*C^2 - 4.020*A*C^3 + 0.677*B^4 - 12.668*B^3*C - 144.091*B^2*C^2 - 206.850*B*C^3 - 62.484*C^4" />
      </Box>
      <Title mt="md" order={4}>
